...
.. toctree::
   ...
   mudlib/advancement-rifts
   mudlib/advancement-simple
   mudlib/adversary-behaviors
   mudlib/adversary-skills
   mudlib/adversary-target
   mudlib/armour-armour_base
   mudlib/armour-complex_slots
   mudlib/armour-limbs
   mudlib/armour-simple_slots
   mudlib/blows-base
   mudlib/body-cmd
   mudlib/body-pockets
   mudlib/body-skills
   mudlib/clusters-base
   mudlib/clusters-navigation
   mudlib/container-vsupport
   mudlib/death-corpses
   mudlib/death-vaporize
   mudlib/event_info-types
   mudlib/health-hit_points
   mudlib/health-limbs
   mudlib/living-effects
   mudlib/living-grammar
   mudlib/living-state_of_mind
   mudlib/object-attributes
   mudlib/object-description
   mudlib/object-flags
   mudlib/object-hooks
   mudlib/object-light
   mudlib/object-mass
   mudlib/object-move
   mudlib/object-msg_recipient
   mudlib/object-names
   mudlib/object-non_object
   mudlib/object-size
   mudlib/object-value
   mudlib/object-visible
   mudlib/object-vsupport
   mudlib/room-exits
   mudlib/room-roomdesc
   mudlib/std-adversary
   mudlib/std-armour
   mudlib/std-base_obj
   mudlib/std-base_room
   mudlib/std-body
   mudlib/std-book
   mudlib/std-container
   mudlib/std-door
   mudlib/std-drink
   mudlib/std-fluid
   mudlib/std-hidden_exit
   mudlib/std-inf_supply
   mudlib/std-material_spawner
   mudlib/std-menu
   mudlib/std-menu2
   mudlib/std-moving_monster
   mudlib/std-moving_room
   mudlib/std-non_room
   mudlib/std-object
   mudlib/std-portal
   mudlib/std-slowheal
   mudlib/std-transient
   mudlib/wield-multiple
   mudlib/wield-wield_base
